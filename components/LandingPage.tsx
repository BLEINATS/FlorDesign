  ...
  return (
    <div className="flex-1 flex flex-col items-center justify-start bg-luxury-cream relative overflow-y-auto no-scrollbar">
      ...
      <div className="w-full px-6 mb-12 animate-slide-up" style={{ animationDelay: '0.2s' }}>
        <div 
          ref={containerRef}
          className="relative w-full aspect-[3/4] max-w-[420px] mx-auto rounded-[45px] overflow-hidden shadow-[0_50px_100px_-20px_rgba(0,0,0,0.3)] bg-white ring-1 ring-black/5 select-none touch-none cursor-ew-resize group border-[10px] border-white"
      ...
      <div className="w-full px-10 pb-16 animate-slide-up flex flex-col items-center" style={{ animationDelay: '0.4s' }}>
        <button
          onClick={onStart}
          className="w-full max-w-[320px] h-[72px] bg-white/20 backdrop-blur-[45px] border border-white/50 text-luxury-slate rounded-[30px] shadow-[0_35px_70px_-12px_rgba(0,0,0,0.15)] active:scale-95 active:bg-white/30 transition-all duration-300 flex items-center justify-center gap-4 group relative overflow-hidden"
        >
